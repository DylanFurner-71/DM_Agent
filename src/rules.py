...
MONSTERS: dict[str, dict] = {
    ...
    # authors can still override it per-NPC, e.g. null for an always-alert sentry.
    # --- low threat ---
    "kobold":          {"name": "Kobold",          "max_hp": 5,   "ac": 12, "attack_bonus": 4, "ability_modifiers": {"str": -2, "dex": 2, "con": -1, "int": -1, "wis": -2, "cha": -1}, "alertness_dc": 8, "inventory": ["dagger", "sling"]},
    "giant_rat":       {"name": "Giant Rat",       "max_hp": 7,   "ac": 12, "attack_bonus": 4, "ability_modifiers": {"str": -2, "dex": 2, "con": 0, "int": -4, "wis": 0, "cha": -3}, "alertness_dc": 10, "inventory": []},
    "cultist":         {"name": "Cultist",         "max_hp": 9,   "ac": 12, "attack_bonus": 3, "ability_modifiers": {"str": 0, "dex": 1, "con": 0, "int": 0, "wis": 0, "cha": 0}, "alertness_dc": 10, "inventory": ["scimitar"]},
    "acolyte":         {"name": "Acolyte",         "max_hp": 9,   "ac": 10, "attack_bonus": 2, "ability_modifiers": {"str": 0, "dex": 0, "con": 0, "int": 0, "wis": 2, "cha": 0}, "alertness_dc": 12, "inventory": ["club"]},
    "guard":           {"name": "Guard",           "max_hp": 11,  "ac": 16, "attack_bonus": 3, "ability_modifiers": {"str": 1, "dex": 1, "con": 1, "int": 0, "wis": 0, "cha": 0}, "alertness_dc": 12, "inventory": ["spear"]},
    "bandit":          {"name": "Bandit",          "max_hp": 11,  "ac": 12, "attack_bonus": 3, "ability_modifiers": {"str": 0, "dex": 1, "con": 1, "int": 0, "wis": 0, "cha": 0}, "alertness_dc": 10, "inventory": ["scimitar", "light crossbow"]},
    "hobgoblin":       {"name": "Hobgoblin",       "max_hp": 11,  "ac": 18, "attack_bonus": 3, "ability_modifiers": {"str": 1, "dex": 1, "con": 1, "int": 0, "wis": 0, "cha": -1}, "alertness_dc": 10, "inventory": ["longsword", "longbow"]},
    "wolf":            {"name": "Wolf",            "max_hp": 11,  "ac": 13, "attack_bonus": 4, "ability_modifiers": {"str": 1, "dex": 2, "con": 1, "int": -4, "wis": 1, "cha": -2}, "alertness_dc": 13, "inventory": []},
    "scout":           {"name": "Scout",           "max_hp": 16,  "ac": 13, "attack_bonus": 4, "ability_modifiers": {"str": 0, "dex": 2, "con": 1, "int": 0, "wis": 1, "cha": 0}, "alertness_dc": 15, "inventory": ["shortsword", "longbow"]},
    "gnoll":           {"name": "Gnoll",           "max_hp": 22,  "ac": 15, "attack_bonus": 4, "ability_modifiers": {"str": 2, "dex": 1, "con": 0, "int": -2, "wis": 0, "cha": -2}, "alertness_dc": 10, "inventory": ["spear", "longbow"]},
    "zombie":          {"name": "Zombie",          "max_hp": 22,  "ac": 8,  "attack_bonus": 3, "ability_modifiers": {"str": 1, "dex": -2, "con": 3, "int": -4, "wis": -2, "cha": -3}, "alertness_dc": 8, "inventory": []},
    "ghoul":           {"name": "Ghoul",           "max_hp": 22,  "ac": 12, "attack_bonus": 4, "ability_modifiers": {"str": 1, "dex": 2, "con": 0, "int": -2, "wis": 0, "cha": -2}, "alertness_dc": 10, "inventory": []},
    "specter":         {"name": "Specter",         "max_hp": 22,  "ac": 12, "attack_bonus": 4, "ability_modifiers": {"str": -5, "dex": 2, "con": 0, "int": 0, "wis": 0, "cha": 0}, "alertness_dc": 10, "inventory": []},
    "giant_spider":    {"name": "Giant Spider",    "max_hp": 26,  "ac": 14, "attack_bonus": 5, "ability_modifiers": {"str": 2, "dex": 3, "con": 1, "int": -4, "wis": 0, "cha": -3}, "alertness_dc": 10, "inventory": []},
    "worg":            {"name": "Worg",            "max_hp": 26,  "ac": 13, "attack_bonus": 5, "ability_modifiers": {"str": 3, "dex": 1, "con": 1, "int": -2, "wis": 0, "cha": -1}, "alertness_dc": 14, "inventory": []},
    "bugbear":         {"name": "Bugbear",         "max_hp": 27,  "ac": 16, "attack_bonus": 4, "ability_modifiers": {"str": 2, "dex": 2, "con": 1, "int": -1, "wis": 0, "cha": -1}, "alertness_dc": 10, "inventory": ["morningstar", "javelin"]},
    "thug":            {"name": "Thug",            "max_hp": 32,  "ac": 11, "attack_bonus": 4, "ability_modifiers": {"str": 2, "dex": 0, "con": 2, "int": 0, "wis": 0, "cha": 0}, "alertness_dc": 10, "inventory": ["mace", "heavy crossbow"]},
    "animated_armor":  {"name": "Animated Armor",  "max_hp": 33,  "ac": 18, "attack_bonus": 4, "ability_modifiers": {"str": 2, "dex": 0, "con": 1, "int": -5, "wis": -4, "cha": -5}, "alertness_dc": 6, "inventory": []},
    "dire_wolf":       {"name": "Dire Wolf",       "max_hp": 37,  "ac": 14, "attack_bonus": 5, "ability_modifiers": {"str": 3, "dex": 2, "con": 2, "int": -4, "wis": 1, "cha": -2}, "alertness_dc": 13, "inventory": []},
    # --- mid threat ---
    "wight":           {"name": "Wight",           "max_hp": 45,  "ac": 14, "attack_bonus": 4, "ability_modifiers": {"str": 2, "dex": 2, "con": 3, "int": 0, "wis": 1, "cha": 2}, "alertness_dc": 13, "inventory": ["longsword", "longbow"]},
    "knight":          {"name": "Knight",          "max_hp": 52,  "ac": 18, "attack_bonus": 5, "ability_modifiers": {"str": 3, "dex": 0, "con": 2, "int": 0, "wis": 0, "cha": 2}, "alertness_dc": 10, "inventory": ["greatsword", "heavy crossbow"]},
    "mummy":           {"name": "Mummy",           "max_hp": 58,  "ac": 11, "attack_bonus": 5, "ability_modifiers": {"str": 3, "dex": -1, "con": 2, "int": -2, "wis": 0, "cha": 1}, "alertness_dc": 10, "inventory": []},
    "veteran":         {"name": "Veteran",         "max_hp": 58,  "ac": 17, "attack_bonus": 5, "ability_modifiers": {"str": 3, "dex": 1, "con": 2, "int": 0, "wis": 0, "cha": 0}, "alertness_dc": 12, "inventory": ["longsword", "shortsword", "heavy crossbow"]},
    "werewolf":        {"name": "Werewolf",        "max_hp": 58,  "ac": 12, "attack_bonus": 4, "ability_modifiers": {"str": 2, "dex": 1, "con": 2, "int": 0, "wis": 0, "cha": 0}, "alertness_dc": 14, "inventory": []},
    "owlbear":         {"name": "Owlbear",         "max_hp": 59,  "ac": 13, "attack_bonus": 7, "ability_modifiers": {"str": 5, "dex": 1, "con": 3, "int": -4, "wis": 1, "cha": -2}, "alertness_dc": 13, "inventory": []},
    "ogre":            {"name": "Ogre",            "max_hp": 59,  "ac": 11, "attack_bonus": 6, "ability_modifiers": {"str": 4, "dex": -1, "con": 3, "int": -3, "wis": -2, "cha": -2}, "alertness_dc": 8, "inventory": ["greatclub", "javelin"]},
    "bandit_captain":  {"name": "Bandit Captain",  "max_hp": 65,  "ac": 15, "attack_bonus": 5, "ability_modifiers": {"str": 2, "dex": 3, "con": 2, "int": 2, "wis": 0, "cha": 2}, "alertness_dc": 10, "inventory": ["scimitar", "dagger"]},
    "berserker":       {"name": "Berserker",       "max_hp": 67,  "ac": 13, "attack_bonus": 5, "ability_modifiers": {"str": 3, "dex": 1, "con": 3, "int": -1, "wis": 0, "cha": -1}, "alertness_dc": 10, "inventory": ["greataxe"]},
    "wraith":          {"name": "Wraith",          "max_hp": 67,  "ac": 13, "attack_bonus": 6, "ability_modifiers": {"str": -2, "dex": 3, "con": 3, "int": 1, "wis": 2, "cha": 2}, "alertness_dc": 12, "inventory": []},
    # --- high threat ---
    "troll":           {"name": "Troll",           "max_hp": 84,  "ac": 15, "attack_bonus": 7, "ability_modifiers": {"str": 4, "dex": 1, "con": 5, "int": -2, "wis": -1, "cha": -2}, "alertness_dc": 12, "inventory": []},
    "hill_giant":      {"name": "Hill Giant",      "max_hp": 105, "ac": 13, "attack_bonus": 8, "ability_modifiers": {"str": 5, "dex": -1, "con": 4, "int": -3, "wis": -1, "cha": -2}, "alertness_dc": 12, "inventory": ["greatclub"]},
    "vampire":         {"name": "Vampire",         "max_hp": 144, "ac": 16, "attack_bonus": 9, "ability_modifiers": {"str": 4, "dex": 4, "con": 4, "int": 3, "wis": 2, "cha": 4}, "alertness_dc": 17, "inventory": []},
    "fire_giant":      {"name": "Fire Giant",      "max_hp": 162, "ac": 18, "attack_bonus": 11, "ability_modifiers": {"str": 7, "dex": -1, "con": 6, "int": 0, "wis": 2, "cha": 1}, "alertness_dc": 16, "inventory": ["greatsword"]},
    "stone_golem":     {"name": "Stone Golem",     "max_hp": 178, "ac": 17, "attack_bonus": 10, "ability_modifiers": {"str": 6, "dex": -1, "con": 5, "int": -4, "wis": 0, "cha": -5}, "alertness_dc": 10, "inventory": []},
    "young_red_dragon": {"name": "Young Red Dragon", "max_hp": 178, "ac": 18, "attack_bonus": 10, "ability_modifiers": {"str": 6, "dex": 0, "con": 5, "int": 2, "wis": 0, "cha": 4}, "alertness_dc": 18, "inventory": []},
    "adult_red_dragon": {"name": "Adult Red Dragon", "max_hp": 256, "ac": 19, "attack_bonus": 14, "ability_modifiers": {"str": 8, "dex": 0, "con": 7, "int": 3, "wis": 1, "cha": 5}, "alertness_dc": 23, "inventory": []},
    "pit_fiend":       {"name": "Pit Fiend",       "max_hp": 300, "ac": 19, "attack_bonus": 14, "ability_modifiers": {"str": 8, "dex": 2, "con": 7, "int": 6, "wis": 4, "cha": 7}, "alertness_dc": 14, "inventory": []},
    "ancient_red_dragon": {"name": "Ancient Red Dragon", "max_hp": 546, "ac": 22, "attack_bonus": 17, "ability_modifiers": {"str": 10, "dex": 0, "con": 9, "int": 4, "wis": 2, "cha": 6}, "alertness_dc": 26, "inventory": []},
    "tarrasque":       {"name": "Tarrasque",       "max_hp": 676, "ac": 25, "attack_bonus": 19, "ability_modifiers": {"str": 10, "dex": 0, "con": 10, "int": -4, "wis": 0, "cha": 0}, "alertness_dc": 10, "inventory": []},
}
